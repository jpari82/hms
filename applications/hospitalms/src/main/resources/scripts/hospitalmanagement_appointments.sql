...
CREATE TABLE `appointments` (
  ...
  `appDay` varchar(45) DEFAULT NULL,
  `attendingDoc` varchar(45) DEFAULT NULL,
  `DoctorName` varchar(45) DEFAULT NULL,
  `attendingNurse` varchar(45) DEFAULT NULL,
  `NurseName` varchar(45) DEFAULT NULL,
  `patient` varchar(45) DEFAULT NULL,
  `patientName` varchar(45) DEFAULT NULL,
  `statusApp` varchar(45) DEFAULT NULL,
  `DoctorsNotes` varchar(45) DEFAULT NULL,
